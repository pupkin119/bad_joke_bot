...
def help(update, context):
    ...
    text += "/set_chat : Установить чат в котором будешь играть в тупые шутки [ используется в лс с ботом ] \n"
    text += "/list_chat : Список чатов в котором играешь в тупые шутки [ используется в лс с ботом ] \n"
